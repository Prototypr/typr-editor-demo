  ...
  return (
    <Popover.Root open={open} onOpenChange={toggleOpen}>
      <Popover.Trigger asChild>
        <button className="absolute bottom-3 right-12 md:bottom-6 md:right-6 z-[999] shadow-lg rounded-full overflow-hidden">
          <img
      ...
      >
        <h3 className="mb-4 font-medium">User state</h3>
