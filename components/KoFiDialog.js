  ...
  return (
    <Dialog.Root open={isOpen} onOpenChange={setIsOpen}>
      <Dialog.Trigger asChild>
        <div
          title={label}
          className="kofi-button font-medium w-fit text-sm hover:shadow-md transition transition-all duration-400 cursor-pointer rounded-lg px-3 h-[28px] flex flex-col justify-center"
        ...
        >
          <div className="kofitext gap-1 flex my-auto items-center">
            <img
              ...
              alt="Ko-Fi button"
            />
            <div className="flex my-auto text-xs font-medium items-center text-white">
              {label}
            </div>
          </div>
        </div>
